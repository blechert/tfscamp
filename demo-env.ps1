...
$env:SYSTEM_TEAMFOUNDATIONSERVERURI = "https://vsrm.dev.azure.com/***REMOVED***/"
$env:SYSTEM_TEAMPROJECT = "***REMOVED***"
...
$env:RELEASE_PRIMARYARTIFACTSOURCEALIAS = "***REMOVED***"
$env:BUILD_REPOSITORY_NAME = "***REMOVED***"
$env:SYSTEM_TEAMFOUNDATIONCOLLECTIONURI = "https://dev.azure.com/***REMOVED***/"
